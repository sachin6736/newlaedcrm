                ...
                <tbody className="divide-y divide-slate-800/80">
                  {leads.map((lead) => (
                    <tr className="transition hover:bg-slate-800/40" key={lead._id}>
                      ...
                      <td className="px-5 py-4">
                        <select
                          className="min-w-[10rem] rounded-full border border-emerald-500/20 bg-emerald-500/15 px-3 py-1.5 text-xs font-bold text-cyan-100 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-60"
